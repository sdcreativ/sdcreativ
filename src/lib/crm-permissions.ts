...
export const CRM_PERMISSION_LABELS: Record<CrmPermission, string> = {
  ...
  "deals.read": "Voir les opportunités",
  "deals.write": "Modifier les opportunités",
  "marketing.read": "Voir le marketing",
  "marketing.write": "Modifier le marketing",
  ...
  "timesheets.read": "Voir le suivi du temps",
  "timesheets.write": "Saisir / modifier le temps",
  "vendors.read": "Voir les prestataires",
  "vendors.write": "Gérer les prestataires & BC",
