...
async function ensureSchema(): Promise<void> {
  ...
  await client.query(`
    ...
    ALTER TABLE blog_posts ADD COLUMN IF NOT EXISTS preview_token VARCHAR(64);
    CREATE UNIQUE INDEX IF NOT EXISTS idx_blog_posts_preview_token ON blog_posts (preview_token)
    ...
    ALTER TABLE blog_posts ADD COLUMN IF NOT EXISTS og_image VARCHAR(512);
    ALTER TABLE blog_posts ADD COLUMN IF NOT EXISTS featured_order SMALLINT;
    CREATE INDEX IF NOT EXISTS idx_blog_posts_featured ON blog_posts (featured_order)
      WHERE featured_order IS NOT NULL AND deleted_at IS NULL;
    ...
    CREATE INDEX IF NOT EXISTS idx_blog_slug_redirects_post ON blog_slug_redirects (post_id);

    ALTER TABLE blog_posts ADD COLUMN IF NOT EXISTS view_count INTEGER NOT NULL DEFAULT 0;
    ALTER TABLE blog_posts ADD COLUMN IF NOT EXISTS click_count INTEGER NOT NULL DEFAULT 0;
    ...
    ALTER TABLE public_team_members ADD COLUMN IF NOT EXISTS image_position VARCHAR(20) NOT NULL DEFAULT '50% 0%';
