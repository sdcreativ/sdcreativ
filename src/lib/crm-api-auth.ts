...
export const crmApiAuth = {
  ...
  deals: { read: read("deals.read"), write: write("deals.write") },
  marketing: { read: read("marketing.read"), write: write("marketing.write") },
  ...
  timesheets: { read: read("timesheets.read"), write: write("timesheets.write") },
  vendors: { read: read("vendors.read"), write: write("vendors.write") },
  calendar: { read: read("calendar.read"), write: write("calendar.write") },
