...
export default async function EnContactPage() {
  ...
  const waUrl = buildWhatsappUrl(contact, "Hello SD CREATIV, I would like to get in touch.");
          ...
          <div className="lg:col-span-2">
            <div className="sticky top-28 space-y-6">
              ...
              <div className="overflow-hidden rounded-3xl bg-dark shadow-xl">
                ...
                <div className="p-8">
                  <h3 className="text-lg font-bold text-white">{contactPageEn.coordsTitle}</h3>
                  <p className="mt-1 text-sm text-white/50">{contactPageEn.coordsSubtitle}</p>
