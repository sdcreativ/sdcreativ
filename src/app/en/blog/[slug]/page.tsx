    ...
    <article>
      ...
      <header className="bg-dark pt-28 pb-12 md:pt-32">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <Breadcrumb items={breadcrumb} className="mb-6" locale="en" />
      ...
      <div className="container mx-auto max-w-3xl px-4 py-12 md:px-6 lg:px-8">
        ...
        <div className="mt-12 rounded-2xl bg-primary-light p-8 text-center">
          <h2 className="text-xl font-bold text-foreground">Planning a web project?</h2>
          <p className="mt-2 text-gray-text">
            Contact SD CREATIV for a free personalized quote.
          </p>
          <Button href="/en/devis" className="mt-4" data-track-cta>
            Get a quote
          </Button>
        </div>
      </div>
