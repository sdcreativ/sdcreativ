...
export const metadata = createMetadata({
  title: "Blog & insights",
  description:
    "Guides and insights on websites, SEO, e-commerce and digital transformation for SMEs.",
  path: "/en/blog",
  locale: "en",
});
  ...
  return (
    <>
      <PageHero
        ...
        description="Practical guides on websites, SEO, e-commerce and AI for SMEs in Côte d'Ivoire and beyond."
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          ...
          {blogPosts.length > 0 && (
            <>
              {featured.length > 0 && (
                <h2 className="mb-8 text-xl font-bold text-foreground">All articles</h2>
              )}
