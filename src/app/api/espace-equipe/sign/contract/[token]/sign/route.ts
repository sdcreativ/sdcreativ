...
import { signEmployeeContractNative } from "@/lib/signature/native-employee-contract";
...
export async function POST(request: Request, { params }: Props) {
  ...
  try {
    ...
    const contract = await signEmployeeContractNative({
      token,
    ...
    console.error("[api/espace-equipe/sign/contract/sign]", error);
