...
import { sendEmployeeContractForEsign } from "@/lib/esign/send-employee-contract";
...
export async function POST(request: Request, { params }: Props) {
  ...
  try {
    ...
    const contract = await sendEmployeeContractForEsign({
      contractId: id,
    ...
    console.error("[api/admin/employee-contracts/esign] POST", error);
