...
export const quoteFormCopy = {
  fr: {
    ...
    emailPh: "vous@entreprise.com",
    companyPh: "Nom de votre société",
    budgetPh: "Ex. 1 200 000 FCFA ou 2 500 €",
    budgetHint: "Indiquez le montant et la devise (FCFA, EUR…).",
  ...
  en: {
    ...
    emailPh: "you@company.com",
    companyPh: "Your company name",
    budgetPh: "e.g. 1,200,000 FCFA or €2,500",
    budgetHint: "Include the amount and currency (FCFA, EUR, etc.).",
