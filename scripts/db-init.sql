...
ALTER TABLE quotes ADD COLUMN IF NOT EXISTS exchange_rate_to_xof NUMERIC(18, 6);
ALTER TABLE quotes ADD COLUMN IF NOT EXISTS exchange_rate_at TIMESTAMPTZ;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS currency VARCHAR(3) NOT NULL DEFAULT 'XOF';
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS exchange_rate_to_xof NUMERIC(18, 6);
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS exchange_rate_at TIMESTAMPTZ;
...
ALTER TABLE crm_settings ADD COLUMN IF NOT EXISTS site_formations JSONB NOT NULL DEFAULT '{}';
...
-- 3CX — journalisation communications (Phase 3)
